# Mirrored from skeletonkey/live/demos.py (ORBITAL_SRC) - a test keeps them in sync.
# Run it: sk live demo  --  or:  sk live start examples/live_hmr/orbital.py && sk live serve --wait
# LiveREPL playground (written by `sk live demo`). This file is WATCHED:
